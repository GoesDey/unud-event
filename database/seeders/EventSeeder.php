...
class EventSeeder extends Seeder
{
   ...
   public function run(): void
   {
      ...
      $eventMapping = [
         'Lomba' => [
            [
               'name' => 'Udayana Hackathon: Inovasi Digital Mahasiswa',
               'location' => 'offline',
               'price' => 50000,
            ],
            [
               'name' => 'Olimpiade Karya Tulis Ilmiah Tingkat Nasional',
               'location' => 'online',
               'price' => 0,
            ],
         ],
         'Seminar' => [
            [
               'name' => 'Seminar Nasional: Eksistensi Budaya Bali di Era Gen-Z',
               'location' => 'offline',
               'price' => 35000,
            ],
            [
               'name' => 'Talkshow Kewirausahaan: Merintis Bisnis Sejak Kuliah',
               'location' => 'offline',
               'price' => 20000,
            ],
         ],
         'Pengabdian' => [
            [
               'name' => 'Udayana Mengabdi: Program Mengajar di Desa Binaan',
               'location' => 'offline',
               'price' => 0,
            ],
            [
               'name' => 'Bakti Sosial: Cek Kesehatan & Donor Darah Massal',
               'location' => 'offline',
               'price' => 0,
            ],
         ],
         'Workshop' => [
            [
               'name' => 'Workshop UI/UX: Membangun Aplikasi Ramah Pengguna',
               'location' => 'offline',
               'price' => 75000,
            ],
            [
               'name' => 'Pelatihan Web Development Menggunakan Laravel',
               'location' => 'online',
               'price' => 50000,
            ],
         ],
         'Webinar' => [
            [
               'name' => 'Webinar Karir: Rahasia Lolos Interview Perusahaan Multinasional',
               'location' => 'online',
               'price' => 0,
            ],
            [
               'name' => 'Webinar Beasiswa: Tips Jitu Tembus LPDP 2026',
               'location' => 'online',
               'price' => 0,
            ],
         ],
         ...
         if (isset($eventMapping[$type->name])) {
            ...
            foreach ($eventMapping[$type->name] as $item) {
               ...
               $event = Event::create([
                  ...
                  'name' => $item['name'],
                  'description' =>
                     'Ini adalah deskripsi dummy untuk acara ' .
                     $item['name'] .
                     '. Acara ini diselenggarakan untuk meningkatkan kapasitas mahasiswa Universitas Udayana.',
               ...
               $detailsPreset = [
                  ...
                  'Syarat & Ketentuan' =>
                     'Membawa KTM aktif dan mengenakan almamater Universitas Udayana.',
               ];
